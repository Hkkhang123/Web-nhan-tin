...
const PREVIEW_MESSAGE = [
  {id: 1, content: "Chào buổi sáng", isSent: false},
  {id: 2, content: "Đây là tin nhắn nhắn test =)))", isSent: true}
]
    ...
    <div className='container mx-auto px-4 pt-20 max-w-5xl'>
      <div className="space-y-6">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-sm text-base-content/70">Chọn một chủ đề cho giao diện chat </p>
        </div>
